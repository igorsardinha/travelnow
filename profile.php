...
<body onload="loading()" style="margin:0;padding:0;">
    ...
    <div class="index-body">
      <header class="menu-container">
        <div class="profile-back">
          <a href="./index.php" id="url-back">⬅️ Voltar para página inicial...</a>
        </div>
  ...
  <input id="file" type="file" onchange="loadFile(event)"/>-->
        ...
        <div class="profile-info">
          <p class="profile-created"><b>Criado:</b>
            <?php echo $create; ?>
          </p>
          <p class="profile-updated"><b>Atualizado:</b>
            <?php echo $update; ?>
          </p>
        </div>
        <br>
      ...
      <form method="post" id="profile-editor-form">
        ...
        <div class="profile-input">
          ...
          <br>
          <input type="email" name="email-show" id="email-show" placeholder="Email" disabled
        ...
        <div class="profile-input">
          ...
          <center>
            <span id="display-forca" class="badge displayBadge" style="font-size: 10pt"></span>
          </center>
        </div>
        <div class="profile-input">
          <label for="confirmar-senha">Confirmar Nova Senha</label>
          <br>
          <input type="password" name="confirmar-senha" id="confirmar-senha" placeholder="Confirmar Nova Senha" />
          <span id="display-identicas" class="badge displayBadge" style="font-size: 9pt"></span>
        </div>
        <br>
        <div class="profile-input">
        ...
        <br>
        <div class="profile-input">
          <center><input type="submit" value="Atualizar Perfil" name="update" class="AtualizarPerfilBtn" />
            <center>
        </div>
      </form>
    </div>
